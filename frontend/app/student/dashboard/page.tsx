  ...
  return (
    <main className="mx-auto flex min-h-screen max-w-3xl flex-col gap-6 px-6 py-10">
      <div className="flex flex-col gap-1">
        <h2 className="text-2xl font-semibold text-gray-900">Ogrenci Paneli</h2>
        <p className="text-sm text-gray-600">
          Hos geldin, <span className="font-medium text-gray-900">{user.display_name}</span>
        </p>
      </div>

      <section className="rounded-lg bg-white p-5 shadow-sm ring-1 ring-gray-200">
        <h3 className="text-base font-semibold text-gray-900">Hizli Erisim</h3>
