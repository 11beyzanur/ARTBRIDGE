...
class EmployerSubscriptionStatus(str, enum.Enum):
    active = "ACTIVE"
    pending = "PENDING"
    unpaid = "UNPAID"
    cancelled = "CANCELED"
...
class EmployerPlanType(str, enum.Enum):
    standard = "STANDARD"
    enterprise = "ENTERPRISE"


class EmployerPackageSubscription(Base):
    __tablename__ = "employer_package_subscriptions"
    ...
    status: Mapped[str] = mapped_column(
        String(32),
        index=True,
        default=EmployerSubscriptionStatus.pending.value,
    )
